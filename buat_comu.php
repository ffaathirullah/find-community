    ...
    <!-- Isi Content -->
      ...
      <div class="row">
        ...
        <div class="col-9 center">
          ...
          $user1 = $s['id'];
    ?>
          <form action="comu_aksi.php" method="post" enctype="multipart/form-data">
            <div class="col inputan">
              <div class="form-row">
                <div class="form-group col-md-5 comm">
                  <label for="inputEmail4">Nama Ketua</label>
                  <input type="text" class="form-control" id="inputEmail4" name="namaketua" placeholder="Nama Ketua">
              </div>
              <div class="form-group col-md-5 comm">
                  <label for="inputEmail4">Nama Komunitas</label>
                  <input type="text" class="form-control" id="inputEmail4" name="namakomunitas" placeholder="Nama Komunitas">
              </div>
            </div>
              <div class="form-row">
                <div class="form-group col-md-5 comm">
                  <label for="inputEmail4">No Telepon</label>
                  <input type="text" class="form-control" id="inputEmail4" name="notelp" placeholder="No Telepon">
              </div>
              <div class="form-group col-md-5 comm">
                  <label for="inputEmail4">Kota</label>
                  <input type="text" class="form-control" id="inputEmail4" name="maps" placeholder="Kota">
             ...
             <div class="form-row">
                <div class="form-group col-md-5 comm">
                  ...
                  <input type="text" class="form-control" id="inputEmail4" name="alamat" placeholder="Alamat">
              </div>
              <div class="form-group col-md-5 comm">
               ...
               <div class="form-group col-md-5 comm">
                  ...
                  <input type="text" class="form-control" id="inputEmail4" name="form" placeholder="From">
