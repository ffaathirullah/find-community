...
<html lang="en">
  ...
  <div class="container semua">
    ...
    $data =   mysqli_query($koneksi, "select * from user where username ='$nama'");
      ...
      $user1 = $s['id'];
    $data = "select a.id,a.nama_komunitas,a.alamat,a.nama,a.jenis_komunitas,a.jml_anggota from communitas a , user u,bergabung b WHERE a.id = b.id_communitas AND u.id = b.id_user AND b.id_user = '$user1' ";
