...
<html lang="en">
  ...
  <div class="container semua">
    <nav class="navbar navbar-expand-lg">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
          <div class="navbar-nav navbar-toogler ml-auto">
            ...
            <a class="nav-item nav-link" href="buat_comu.php"><b>Community</b></a>
            <a class="nav-item nav-link" href="my_communitas.php"><b>MYcommunitas</b></a>
    ...
    $nama = $_POST['nama'];
    $no = 1;
    $data = "select * from communitas where nama_komunitas like '%$nama%' or jenis_komunitas like '%$nama%' or alamat like '%$nama'";
